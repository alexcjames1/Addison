        ...
        return(
            <div className={style.products}>
                <Section className={style.chartContainer} size="normal">
                    ...
                    <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRFl550uu-e6ihb87LmxPe_WsKrw7pDZRbRjUscMpu_kMgxXnFo4Uc_LULyC0Bzaw/pubhtml?gid=1111029499&amp;single=true&amp;widget=true&amp;headers=false" className={style.pipeChart}></iframe>
